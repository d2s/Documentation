...
There is also [a release candidate](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v5.9.2rc), see [changelog](https://rsyncosx.github.io/Changelog). The release candidate is signed and notarized.
