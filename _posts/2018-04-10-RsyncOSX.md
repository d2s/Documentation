...
permalink: Install
---
RsyncOSX is [released](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v6.1.7) in version 6.1.7 (5 February 2020). It is **not** required to install the [RsyncOSXsched.app](https://github.com/rsyncOSX/RsyncOSXsched). RsyncOSXsched.app is for scheduled tasks only.
...
- RsyncOSX-6.1.7.dmg - a7a0377af5a238a4d5461eabc23d8852444909b9
-	RsyncOSXsched-6.1.7.dmg - 8f27c67026f3caeb01b92dfbbf85ce4cc5a63a4e
