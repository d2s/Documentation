...
RsyncOSX is [released](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v5.5.0) in version 5.5.0 (5 September 2018). The `RsyncOSX-version.dmg` file is signed with my Apple ID developer certificate. It is **not** required to install the [RsyncOSXsched.app](https://github.com/rsyncOSX/RsyncOSXsched). RsyncOSXsched.app is for scheduled backups only.
