...
permalink: Install
---
RsyncOSX is [released](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v6.1.0) in version 6.1.0 (24 December 2019). It is **not** required to install the [RsyncOSXsched.app](https://github.com/rsyncOSX/RsyncOSXsched). RsyncOSXsched.app is for scheduled tasks only.
...
- RsyncOSX-6.1.0.dmg - 7161a463235258c72f5cce50c95ee44a055dbda7
-	RsyncOSXsched-6.1.0.dmg - 5ef69414dd01f4258f0202bb6f78bda901b494e0
