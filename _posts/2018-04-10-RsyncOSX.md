...
permalink: Install
---
RsyncOSX is [released](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v5.9.3) in version 5.9.3 (12 September 2019). It is **not** required to install the [RsyncOSXsched.app](https://github.com/rsyncOSX/RsyncOSXsched). RsyncOSXsched.app is for scheduled tasks only.
...
- RsyncOSX-5.9.3.dmg - 9931c6119f53ca386284a4258b10c14f87d9d0b9  
- RsyncOSXsched-5.9.3.dmg - cdb7a3139bad6d0d89b6dc4820fb00bd650c9f3b  
