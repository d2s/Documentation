...
permalink: Install
---
RsyncOSX is [released](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v6.0.1) in version 6.0.1 (10 November 2019). It is **not** required to install the [RsyncOSXsched.app](https://github.com/rsyncOSX/RsyncOSXsched). RsyncOSXsched.app is for scheduled tasks only.
...
- RsyncOSX-6.0.1.dmg - 61537e55b8c05488ffb3a7e291aa91ef0391c42a
-	RsyncOSXsched-6.0.1.dmg - 4911a6d729294eca94ad3223a1410ac8fc29c9fb
