...
There is also [a release candidate](https://github.com/rsyncOSX/RsyncOSX/releases/tag/v5.9.1rc), see [changelog](https://rsyncosx.github.io/Changelog). The release candidate is signed but not notarized.
