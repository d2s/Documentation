...
The FreeNAS OS on my NAS is for the moment replaced due to very slow rsync transfer rate. FreeBSD 11.2 is installed and zpools created on FreeNAS are imported in FreeBSD.
