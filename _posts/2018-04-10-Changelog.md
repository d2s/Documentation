...
- the `automatic execution` (double arrow or shortcut `⌘B`) reports "There seems to be nothing to do..." when it is files to be synchronized, for execution of several tasks please use the quick backup feature..
